...
with no approval events in the corpora, the antecedent of O1--O5 is vacuously satisfied
and a firing depends only on the tool's class, so a keyword rule set would reach the same
verdicts. Why that is a property of the corpora and not of MFOTL is the subject of
