...
Against this gold set the keyword typing has micro-averaged precision $0.90$, recall
$0.84$, F1 $0.87$, and single-primary exact-match $87.0\%$ ($47/54$); the residual errors are
systematic (e.g.\ \texttt{send\_\allowbreak channel\_\allowbreak message} and
\texttt{send\_\allowbreak direct\_\allowbreak message} missed by export,
\texttt{reserve\_hotel} and \texttt{reserve\_restaurant} missed by financial) not
random, and we report them without tuning (per-class table in
...
\subsection{Timed CPS/IoT policies: evaluability under the proposed schema}
\label{sec:cps}
