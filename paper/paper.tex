...
context \emph{is} available, MFOTL expresses genuinely more discriminating policies, and
...
\item \textbf{An empirical characterisation of when formal RV adds value.} Generic
      ...
      available, data-parametric and metric MFOTL policies produce genuinely
...
the two is the point: the generic layer establishes how much of the recorded attack
...
% ============================================================================
\section{Threats to the Verdict: Canonicalisation and Provenance}
\label{sec:canon}
...
\subsection{What the schema would unlock: timed CPS/IoT policies}
\label{sec:cps}
