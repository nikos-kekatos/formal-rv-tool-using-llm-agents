...
\paragraph{Positioning} What formal RV adds is the combination: trace-level scope,
formal temporal semantics, data-parametric provenance and offline evaluability in
\emph{one} declarative substrate. The comparison is with what the cited systems were
